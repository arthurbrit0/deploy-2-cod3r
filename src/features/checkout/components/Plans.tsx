      ...
      <div className="relative h-full mb-16 w-full overflow-hidden bg-none">
        <div className="mx-auto max-w-7xl px-6 py-24">
          ...
          <h2 className="text-center text-4xl font-bold tracking-tight text-white">
            Escolha seu plano e se junte a mais de 5000 alunos!
          </h2>
          <p className="text-md text-center font-semibold text-gray-200">Confira os planos da Formação DEV</p>
          </div>
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            {pricingPlans.map((plan, index) => (
              <Card key={index} className="overflow-hidden bg-black/75 border border-purple-500/20 backdrop-blur-sm flex flex-col">
