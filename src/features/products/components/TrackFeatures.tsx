...
export default function TrackFeatures() {
  ...
  return (
    <div className="mx-auto max-w-5xl pt-24">
      ...
      <div className="relative min-h-[500px] bg-gray-900 border border-slate-800 rounded-3xl shadow p-20">
        <div className="absolute inset-0">
          <div className="absolute inset-0 rounded-3xl bg-[radial-gradient(circle_500px_at_50%_-100px,rgba(30,30,30,0.7)_0%,rgba(60,60,60,0)_70%)]" />
          <div className="absolute inset-0 rounded-3xl bg-[radial-gradient(circle_700px_at_0%_400px,rgba(20,20,20,0.7)_0%,rgba(50,50,50,0)_70%)]" />
          <div className="absolute inset-0 rounded-3xl bg-[radial-gradient(circle_800px_at_100%_300px,rgba(10,10,10,0.7)_0%,rgba(40,40,40,0)_70%)]" />
        </div>
        ...
        {tabsData.map((tab, index) => {
          ...
          return (
            <div
              key={tab.id}
              className={`absolute inset-0 flex flex-col transition-opacity transition-transform duration-300 ease-in-out
